...
SWEP.VisualRecoilDoingFunc = function(up, side, roll, punch, recamount)
    if recamount > 3 then
        recamount = 2 - math.Clamp((recamount - 3) / 5, 0, 1)
...
SWEP.MalfunctionMeanShotsToFail = 1.5 * 230
