...
-- Stocks
	if wep:HasElement("eft_sag545_buffertube") then vec = vec + Vector(-4, 6, 0) end
...
-- Stocks
	if wep:HasElement("eft_sag545_buffertube") then vec = vec + Vector(-4, 0, 0) end
