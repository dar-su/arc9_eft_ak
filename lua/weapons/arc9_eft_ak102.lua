...
SWEP.VisualRecoilSide = 4*1.8 -- Horizontal tilt
...
SWEP.VisualRecoilThinkFunc = function(springconstant, VisualRecoilSpringMagnitude, PUNCH_DAMPING, recamount)
    if recamount > 2 then
        ...
        return springconstant * math.max(1, 10 * recamount) * 105, VisualRecoilSpringMagnitude * 0.75, PUNCH_DAMPING * 0.75
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Category = {"eft_custom_slot", "eft_custom_slot_ak", "eft_custom_slot_ak102"},
        Bone = "mod_pistol_grip",
        Pos = Vector(0, -8, -5),
        Ang = Angle(0, 0, 0),
    },
