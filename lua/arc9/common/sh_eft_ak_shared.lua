...
ARC9EFT.AK_Anims = {
    ...
    ["jam0"] = {
        ...
        EventTable = {
            { s = randspin, t = 0.22 + 0.8 },            
            { s = path.."ak74_slider_up.wav", t = 0.68 + 0.8},
            { s = path.."ak74_slider_down.wav", t = 0.88 + 0.8},
            { s = randspin, t = 1.41 + 0.8 },        
        },
        EjectAt = 0.74 + 0.8
    },
    ["jam2"] = {
        ...
        EventTable = {
            { s = randspin, t = 2/24 + 0.8 },
            { s = randspin, t = 12/24 + 0.8 },
            { s = path .. "ak_jam_stuckbolt_in_starting.wav", t = 16/24 + 0.8 },
            { s = path .. "ak_jam_stuckbolt_in1.wav", t = 22/24 + 0.8 },
            { s = path .. "ak_jam_stuckbolt_in_moving.wav", t = 36/24  + 0.8},
            { s = path .. "ak_jam_feedfault_roundaftercharge.wav", t = 40/24 + 0.8 },
            { s = path .. "ak_jam_feedfault_extraction_nohand.wav", t = 46/24  + 0.8},
            { s = randspin, t = 50/24  + 0.8},
            { s = path .. "ak74_slider_down.wav", t = 61/24  + 0.8},
            { s = randspin, t = 72/24  + 0.8},
        },
    },
    ["jam3"] = {
        ...
        EventTable = {
            { s = randspin, t = 0.2 },
            { s = path .. "ak_jam_stuckbolt_in_starting.wav", t = 0.89 + 0.8 },
            { s = path .. "ak_jam_stuckbolt_in1.wav", t = 0.99 + 0.8 },
            { s = path .. "ak_jam_stuckbolt_in2.wav", t = 1.5 + 0.8 },
            { s = randspin, t = 1.94  + 0.8},
            { s = path .. "ak_jam_stuckbolt_out_hit3.wav", t = 2.25 + 0.8 },
            { s = path .. "ak_jam_stuckbolt_out_hit2.wav", t = 2.62 + 0.8 },
            { s = randspin, t = 3.13  + 0.8},
            { s = path .. "ak_jam_stuckbolt_in_starting.wav", t = 3.35 + 0.8 },
            { s = path .. "ak_jam_stuckbolt_in3.wav", t = 3.66 + 0.8 },
            { s = path .. "ak_jam_stuckbolt_in1.wav", t = 3.97 + 0.8 },
            { s = path .. "ak_jam_stuckbolt_in_moving.wav", t = 4.3 + 0.8 },
            { s = path .. "ak_jam_feedfault_extraction_nohand.wav", t = 4.45  + 0.8},
            { s = path .. "ak74_slider_down.wav", t = 4.54 + 0.8 },
            { s = randspin, t = 4.85  + 0.8},
        },
        EjectAt = 4.45 + 0.8
    },
    ["jam4"] = {
        ...
        EventTable = {
            { s = randspin, t = 0.14 + 0.8 },
            { s = path .. "ak_jam_stuckbolt_in_starting.wav", t = 0.65 + 0.8 },
            { s = path .. "ak_jam_stuckbolt_in3.wav", t = 0.95 + 0.8 },
            { s = path .. "ak_jam_stuckbolt_in2.wav", t = 1.62 + 0.8 },
            { s = path .. "ak_jam_stuckbolt_in1.wav", t = 1.89 },
            { s = path .. "ak_jam_stuckbolt_in_moving.wav", t = 2.14 + 0.8 },
            { s = path .. "ak74_slider_down.wav", t = 2.38 + 0.8 },
            { s = randspin, t = 2.9  + 0.8},
        }
    },
    ["jam1"] = {
        Source = "jam_shell", -- jam shell
        EventTable = {
            { s = randspin, t = 0.07  + 0.8},
            { s = path .. "ak_jam_shell_grab.wav", t = 0.59 + 0.8 },
            { s = path .. "ak_jam_feedfault_extraction_nohand.wav", t = 0.75  + 0.8},
            { s = path .. "ak_jam_shell_remove.wav", t = 0.91 + 0.8 },
            { s = randspin, t = 1.59 + 0.8 },
        },
    },
